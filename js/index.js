...
let todosArtigos = {}; // Usado para referência global nos cálculos
...
$(document).ready(() => {
    ...
    function aplicarArtigosCategoria(categoria, artigos) {
        for (const [codigo, dados] of Object.entries(artigos)) {
            todosArtigos[codigo] = dados; // Salva para referência
...
function finalizar(event) {
    ...
    // Agora: apenas crimes inafiançáveis (gravíssimos) entram na pena parcial
...
function copiarTexto(tipo) {
    ...
    switch (tipo) {
        case 'penaTotal':
            texto = `Pena Total (Crimes Inafiançáveis)\nNome: ${$('#nomeTotal').text()}\nCPF: ${$('#cpfTotal').text()}\nArtigos: ${$('#artigosTotal').text()}\nPena: ${$('#penaTotal').text()}\nMulta: ${$('#multaTotal').text()}\nFiança: ${$('#fiancaTotal').text()}`;
            break;
        case 'penaParcial':
            texto = `Pena Parcial (com pagamento de fiança)\nNome: ${$('#nomeParcial').text()}\nCPF: ${$('#cpfParcial').text()}\nArtigos: ${$('#artigosParcial').text()}\nPena: ${$('#penaParcial').text()}\nMulta: ${$('#multaParcial').text()}\nFiança: ${$('#fiancaParcial').text()}`;
            break;
        case 'liberdade':
            texto = `Liberdade (pagamento de fiança total)\nNome: ${$('#nomeLiberdade').text()}\nCPF: ${$('#cpfLiberdade').text()}\nArtigos: ${$('#artigosLiberdade').text()}\nPena: ${$('#penaLiberdade').text()}\nMulta: ${$('#multaLiberdade').text()}\nFiança: ${$('#fiancaLiberdade').text()}`;
            break;
        default:
